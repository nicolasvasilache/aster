...
amdgcn.module @test_global_load_counting target = #amdgcn.target<gfx942> isa = #amdgcn.isa<cdna3> {
  amdgcn.kernel @test_kernel {
    ...
    %6, %tok6 = amdgcn.load global_load_dword dest %dst_range0 addr %addr_range : dps(!amdgcn.vgpr_range<[? + 1]>) ins(!amdgcn.sgpr_range<[? + 2]>) -> !amdgcn.read_token<flat>
    %dst_range1 = amdgcn.make_register_range %1 : !amdgcn.vgpr
    %7, %tok7 = amdgcn.load global_load_dword dest %dst_range1 addr %addr_range offset c(%c4) : dps(!amdgcn.vgpr_range<[? + 1]>) ins(!amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.read_token<flat>
    %dst_range2 = amdgcn.make_register_range %2 : !amdgcn.vgpr
    %8, %tok8 = amdgcn.load global_load_dword dest %dst_range2 addr %addr_range offset c(%c8) : dps(!amdgcn.vgpr_range<[? + 1]>) ins(!amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.read_token<flat>
    ...
    %tok_store = amdgcn.store global_store_dword data %data_range addr %addr_range offset c(%c12) : ins(!amdgcn.vgpr_range<[? + 1]>, !amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.write_token<flat>
...
amdgcn.module @test_ds_read_counting target = #amdgcn.target<gfx942> isa = #amdgcn.isa<cdna3> {
  amdgcn.kernel @test_kernel {
    ...
    %c12 = arith.constant 12 : i32
    %dst_range0 = amdgcn.make_register_range %0 : !amdgcn.vgpr
    %5, %tok5 = amdgcn.load ds_read_b32 dest %dst_range0 addr %4 : dps(!amdgcn.vgpr_range<[? + 1]>) ins(!amdgcn.vgpr) -> !amdgcn.read_token<shared>
    %dst_range1 = amdgcn.make_register_range %1 : !amdgcn.vgpr
    %6, %tok6 = amdgcn.load ds_read_b32 dest %dst_range1 addr %4 offset c(%c4) : dps(!amdgcn.vgpr_range<[? + 1]>) ins(!amdgcn.vgpr, i32) -> !amdgcn.read_token<shared>
    %dst_range2 = amdgcn.make_register_range %2 : !amdgcn.vgpr
    %7, %tok7 = amdgcn.load ds_read_b32 dest %dst_range2 addr %4 offset c(%c8) : dps(!amdgcn.vgpr_range<[? + 1]>) ins(!amdgcn.vgpr, i32) -> !amdgcn.read_token<shared>
    ...
    %tok_write = amdgcn.store ds_write_b32 data %data_range addr %4 offset c(%c12) : ins(!amdgcn.vgpr_range<[? + 1]>, !amdgcn.vgpr, i32) -> !amdgcn.write_token<shared>
...
amdgcn.module @test_global_mixed_counting target = #amdgcn.target<gfx942> isa = #amdgcn.isa<cdna3> {
  amdgcn.kernel @test_kernel {
    ...
    // Two global loads
    %dst_range0 = amdgcn.make_register_range %0 : !amdgcn.vgpr
    %6, %tok6 = amdgcn.load global_load_dword dest %dst_range0 addr %addr_range offset c(%c0) : dps(!amdgcn.vgpr_range<[? + 1]>) ins(!amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.read_token<flat>
    // Store at non aliasing location
    %data_range0 = amdgcn.make_register_range %2 : !amdgcn.vgpr
    %tok_s0 = amdgcn.store global_store_dword data %data_range0 addr %addr_range offset c(%c8) : ins(!amdgcn.vgpr_range<[? + 1]>, !amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.write_token<flat>
    %dst_range1 = amdgcn.make_register_range %1 : !amdgcn.vgpr
    %7, %tok7 = amdgcn.load global_load_dword dest %dst_range1 addr %addr_range offset c(%c4) : dps(!amdgcn.vgpr_range<[? + 1]>) ins(!amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.read_token<flat>
    ...
    %tok_s1 = amdgcn.store global_store_dword data %data_range1 addr %addr_range offset c(%c12) : ins(!amdgcn.vgpr_range<[? + 1]>, !amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.write_token<flat>
...
amdgcn.module @test_ds_mixed_counting target = #amdgcn.target<gfx942> isa = #amdgcn.isa<cdna3> {
  amdgcn.kernel @test_kernel {
    ...
    %gl0, %tok_gl0 = amdgcn.load global_load_dword dest %g_range0 addr %addr_range offset c(%c0_g) : dps(!amdgcn.vgpr_range<[? + 1]>) ins(!amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.read_token<flat>
    %gl1, %tok_gl1 = amdgcn.load global_load_dword dest %g_range1 addr %addr_range offset c(%c4_g) : dps(!amdgcn.vgpr_range<[? + 1]>) ins(!amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.read_token<flat>
    %gl2, %tok_gl2 = amdgcn.load global_load_dword dest %g_range2 addr %addr_range offset c(%c8_g) : dps(!amdgcn.vgpr_range<[? + 1]>) ins(!amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.read_token<flat>
    %gl3, %tok_gl3 = amdgcn.load global_load_dword dest %g_range3 addr %addr_range offset c(%c12_g) : dps(!amdgcn.vgpr_range<[? + 1]>) ins(!amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.read_token<flat>
    %gl4, %tok_gl4 = amdgcn.load global_load_dword dest %g_range4 addr %addr_range offset c(%c16_g) : dps(!amdgcn.vgpr_range<[? + 1]>) ins(!amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.read_token<flat>
    %gl5, %tok_gl5 = amdgcn.load global_load_dword dest %g_range5 addr %addr_range offset c(%c20_g) : dps(!amdgcn.vgpr_range<[? + 1]>) ins(!amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.read_token<flat>
    ...
    %tok_dsw0 = amdgcn.store ds_write_b32 data %ds_wr_range0 addr %ds_addr offset c(%c0_ds) : ins(!amdgcn.vgpr_range<[? + 1]>, !amdgcn.vgpr, i32) -> !amdgcn.write_token<shared>
    ...
    %tok_dsw1 = amdgcn.store ds_write_b32 data %ds_wr_range1 addr %ds_addr offset c(%c4_ds) : ins(!amdgcn.vgpr_range<[? + 1]>, !amdgcn.vgpr, i32) -> !amdgcn.write_token<shared>
    ...
    %tok_dsw2 = amdgcn.store ds_write_b32 data %ds_wr_range2 addr %ds_addr offset c(%c8_ds) : ins(!amdgcn.vgpr_range<[? + 1]>, !amdgcn.vgpr, i32) -> !amdgcn.write_token<shared>
    ...
    %tok_dsw3 = amdgcn.store ds_write_b32 data %ds_wr_range3 addr %ds_addr offset c(%c12_ds) : ins(!amdgcn.vgpr_range<[? + 1]>, !amdgcn.vgpr, i32) -> !amdgcn.write_token<shared>
    ...
    %tok_dsw4 = amdgcn.store ds_write_b32 data %ds_wr_range4 addr %ds_addr offset c(%c16_ds) : ins(!amdgcn.vgpr_range<[? + 1]>, !amdgcn.vgpr, i32) -> !amdgcn.write_token<shared>
    ...
    %tok_dsw5 = amdgcn.store ds_write_b32 data %ds_wr_range5 addr %ds_addr offset c(%c20_ds) : ins(!amdgcn.vgpr_range<[? + 1]>, !amdgcn.vgpr, i32) -> !amdgcn.write_token<shared>
    ...
    %dr0, %tok_dr0 = amdgcn.load ds_read_b64 dest %ds_rd_range0 addr %ds_addr offset c(%c4_ds) : dps(!amdgcn.vgpr_range<[? + 2]>) ins(!amdgcn.vgpr, i32) -> !amdgcn.read_token<shared>
    // CHECK-NOT:   amdgcn.sopp.s_waitcnt
    // CHECK:   load ds_read_b64
    %ds_rd_range1 = amdgcn.make_register_range %ds2, %ds3 : !amdgcn.vgpr, !amdgcn.vgpr
    %dr1, %tok_dr1 = amdgcn.load ds_read_b64 dest %ds_rd_range1 addr %ds_addr offset c(%c4_ds) : dps(!amdgcn.vgpr_range<[? + 2]>) ins(!amdgcn.vgpr, i32) -> !amdgcn.read_token<shared>
    ...
    %dr2, %tok_dr2 = amdgcn.load ds_read_b64 dest %ds_rd_range2 addr %ds_addr offset c(%c12_ds) : dps(!amdgcn.vgpr_range<[? + 2]>) ins(!amdgcn.vgpr, i32) -> !amdgcn.read_token<shared>
    // CHECK-NOT:   amdgcn.sopp.s_waitcnt
    // CHECK:   load ds_read_b64
    %ds_rd_range3 = amdgcn.make_register_range %ds6, %ds7 : !amdgcn.vgpr, !amdgcn.vgpr
    %dr3, %tok_dr3 = amdgcn.load ds_read_b64 dest %ds_rd_range3 addr %ds_addr offset c(%c12_ds) : dps(!amdgcn.vgpr_range<[? + 2]>) ins(!amdgcn.vgpr, i32) -> !amdgcn.read_token<shared>
    ...
    %dr4, %tok_dr4 = amdgcn.load ds_read_b64 dest %ds_rd_range4 addr %ds_addr offset c(%c20_ds) : dps(!amdgcn.vgpr_range<[? + 2]>) ins(!amdgcn.vgpr, i32) -> !amdgcn.read_token<shared>
    // CHECK-NOT:   amdgcn.sopp.s_waitcnt
    // CHECK:   load ds_read_b64
    %ds_rd_range5 = amdgcn.make_register_range %ds10, %ds11 : !amdgcn.vgpr, !amdgcn.vgpr
    %dr5, %tok_dr5 = amdgcn.load ds_read_b64 dest %ds_rd_range5 addr %ds_addr offset c(%c20_ds) : dps(!amdgcn.vgpr_range<[? + 2]>) ins(!amdgcn.vgpr, i32) -> !amdgcn.read_token<shared>
    ...
    %tok_gs0 = amdgcn.store global_store_dword data %s_range0 addr %addr_range offset c(%c24_g) : ins(!amdgcn.vgpr_range<[? + 1]>, !amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.write_token<flat>
    // CHECK-NOT:   amdgcn.sopp.s_waitcnt
    // CHECK:   store global_store_dword
    ...
    %tok_gs1 = amdgcn.store global_store_dword data %s_range1 addr %addr_range offset c(%c28_g) : ins(!amdgcn.vgpr_range<[? + 1]>, !amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.write_token<flat>
    // CHECK-NOT:   amdgcn.sopp.s_waitcnt
    // CHECK:   store global_store_dword
    ...
    %tok_gs2 = amdgcn.store global_store_dword data %s_range2 addr %addr_range offset c(%c32_g) : ins(!amdgcn.vgpr_range<[? + 1]>, !amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.write_token<flat>
    // CHECK-NOT:   amdgcn.sopp.s_waitcnt
    // CHECK:   store global_store_dword
    ...
    %tok_gs3 = amdgcn.store global_store_dword data %s_range3 addr %addr_range offset c(%c36_g) : ins(!amdgcn.vgpr_range<[? + 1]>, !amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.write_token<flat>
    // CHECK-NOT:   amdgcn.sopp.s_waitcnt
    // CHECK:   store global_store_dword
    ...
    %tok_gs4 = amdgcn.store global_store_dword data %s_range4 addr %addr_range offset c(%c40_g) : ins(!amdgcn.vgpr_range<[? + 1]>, !amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.write_token<flat>
    // CHECK-NOT:   amdgcn.sopp.s_waitcnt
    // CHECK:   store global_store_dword
    ...
    %tok_gs5 = amdgcn.store global_store_dword data %s_range5 addr %addr_range offset c(%c44_g) : ins(!amdgcn.vgpr_range<[? + 1]>, !amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.write_token<flat>
    ...
    %fl0, %tok_fl0 = amdgcn.load global_load_dword dest %f_range0 addr %addr_range offset c(%c24_g) : dps(!amdgcn.vgpr_range<[? + 1]>) ins(!amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.read_token<flat>
    // CHECK-NOT:   amdgcn.sopp.s_waitcnt
    // CHECK:   load global_load_dword
    %f_range1 = amdgcn.make_register_range %f1 : !amdgcn.vgpr
    %fl1, %tok_fl1 = amdgcn.load global_load_dword dest %f_range1 addr %addr_range offset c(%c24_g) : dps(!amdgcn.vgpr_range<[? + 1]>) ins(!amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.read_token<flat>
    ...
    %fl2, %tok_fl2 = amdgcn.load global_load_dword dest %f_range2 addr %addr_range offset c(%c32_g) : dps(!amdgcn.vgpr_range<[? + 1]>) ins(!amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.read_token<flat>
    // CHECK-NOT:   amdgcn.sopp.s_waitcnt
    // CHECK:   load global_load_dword
    %f_range3 = amdgcn.make_register_range %f3 : !amdgcn.vgpr
    %fl3, %tok_fl3 = amdgcn.load global_load_dword dest %f_range3 addr %addr_range offset c(%c32_g) : dps(!amdgcn.vgpr_range<[? + 1]>) ins(!amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.read_token<flat>
    ...
    %fl4, %tok_fl4 = amdgcn.load global_load_dword dest %f_range4 addr %addr_range offset c(%c36_g) : dps(!amdgcn.vgpr_range<[? + 1]>) ins(!amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.read_token<flat>
    ...
    %fl5, %tok_fl5 = amdgcn.load global_load_dword dest %f_range5 addr %addr_range offset c(%c44_g) : dps(!amdgcn.vgpr_range<[? + 1]>) ins(!amdgcn.sgpr_range<[? + 2]>, i32) -> !amdgcn.read_token<flat>
