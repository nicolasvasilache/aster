...
// CHECK-LABEL:   func.func @test_allocated() -> !amdgcn.sgpr<[0 : 4]> {
...
// CHECK:           amdgcn.test_inst outs %[[MAKE_REGISTER_RANGE_1]] ins %[[MAKE_REGISTER_RANGE_0]] : (!amdgcn.sgpr<[0 : 4]>, !amdgcn.sgpr<[8 : 12]>) -> ()
// CHECK:           return %[[MAKE_REGISTER_RANGE_1]] : !amdgcn.sgpr<[0 : 4]>
// CHECK:         }
func.func @test_allocated() -> !amdgcn.sgpr<[0 : 4]> {
  %alloca = memref.alloca() : memref<!amdgcn.sgpr<[0 : 4]>>
  %alloca_0 = memref.alloca() : memref<!amdgcn.sgpr<[8 : 12]>>
  %0 = memref.load %alloca[] : memref<!amdgcn.sgpr<[0 : 4]>>
  %1 = memref.load %alloca_0[] : memref<!amdgcn.sgpr<[8 : 12]>>
  amdgcn.test_inst outs %0 ins %1 : (!amdgcn.sgpr<[0 : 4]>, !amdgcn.sgpr<[8 : 12]>) -> ()
  memref.store %0, %alloca[] : memref<!amdgcn.sgpr<[0 : 4]>>
  %3 = memref.load %alloca[] : memref<!amdgcn.sgpr<[0 : 4]>>
  return %3 : !amdgcn.sgpr<[0 : 4]>
}
