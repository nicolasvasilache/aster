...
// CHECK-DAG:       %[[VAL_4:.*]] = alloca : !amdgcn.vgpr<4>
// CHECK-DAG:       %[[VAL_5:.*]] = alloca : !amdgcn.vgpr<5>
// CHECK:           amdgcn.vop1.vop1 <v_mov_b32_e32> %[[VAL_0]], %[[VAL_4]] : (!amdgcn.vgpr<0>, !amdgcn.vgpr<4>) -> ()
// CHECK:           test_inst outs %[[VAL_4]] : (!amdgcn.vgpr<4>) -> ()
// CHECK:           amdgcn.vop1.vop1 <v_mov_b32_e32> %[[VAL_1]], %[[VAL_5]] : (!amdgcn.vgpr<1>, !amdgcn.vgpr<5>) -> ()
// CHECK:           test_inst outs %[[VAL_5]] : (!amdgcn.vgpr<5>) -> ()
...
// CHECK:           cf.cond_br %[[CALL_0]], ^bb1, ^bb2
// CHECK:         ^bb1:
// CHECK:           test_inst outs %[[VAL_1]] ins %[[VAL_0]], %[[VAL_4]] : (!amdgcn.vgpr<1>, !amdgcn.vgpr<0>, !amdgcn.vgpr<2>) -> ()
// CHECK:           cf.br ^bb3
// CHECK:         ^bb2:
// CHECK:           test_inst outs %[[VAL_0]] ins %[[VAL_1]], %[[VAL_5]] : (!amdgcn.vgpr<0>, !amdgcn.vgpr<1>, !amdgcn.vgpr<3>) -> ()
// CHECK:           cf.br ^bb3
// CHECK:         ^bb3:
// CHECK:           end_kernel
// CHECK:         }
...
// CHECK-DAG:       %[[VAL_2:.*]] = alloca : !amdgcn.sgpr<0>
// CHECK-DAG:       %[[VAL_3:.*]] = alloca : !amdgcn.vgpr<2>
// CHECK-DAG:       %[[VAL_4:.*]] = alloca : !amdgcn.vgpr<3>
// CHECK:           %[[CALL_0:.*]] = func.call @rand() : () -> i1
// CHECK:           test_inst outs %[[VAL_0]] ins %[[VAL_2]] : (!amdgcn.vgpr<0>, !amdgcn.sgpr<0>) -> ()
// CHECK:           test_inst outs %[[VAL_1]] ins %[[VAL_2]] : (!amdgcn.vgpr<1>, !amdgcn.sgpr<0>) -> ()
// CHECK:           cf.cond_br %[[CALL_0]], ^bb1, ^bb2
// CHECK:         ^bb1:
// CHECK:           test_inst outs %[[VAL_3]] ins %[[VAL_0]] : (!amdgcn.vgpr<2>, !amdgcn.vgpr<0>) -> ()
// CHECK:           cf.br ^bb3
// CHECK:         ^bb2:
// CHECK:           test_inst outs %[[VAL_4]] ins %[[VAL_1]] : (!amdgcn.vgpr<3>, !amdgcn.vgpr<1>) -> ()
// CHECK:           cf.br ^bb3
// CHECK:         ^bb3:
...
// CHECK-DAG:       %[[VAL_6:.*]] = alloca : !amdgcn.sgpr<5>
// CHECK:           %[[VAL_7:.*]] = make_register_range %[[VAL_0]], %[[VAL_1]], %[[VAL_2]], %[[VAL_3]] : !amdgcn.sgpr<0>, !amdgcn.sgpr<1>, !amdgcn.sgpr<2>, !amdgcn.sgpr<3>
...
// CHECK-DAG:       %[[VAL_3:.*]] = alloca : !amdgcn.sgpr<11>
// CHECK-DAG:       %[[VAL_4:.*]] = alloca : !amdgcn.vgpr<2>
// CHECK-DAG:       %[[VAL_5:.*]] = alloca : !amdgcn.vgpr<3>
// CHECK-DAG:       %[[VAL_6:.*]] = alloca : !amdgcn.sgpr<1>
// CHECK-DAG:       %[[VAL_7:.*]] = alloca : !amdgcn.sgpr<3>
// CHECK-DAG:       %[[VAL_8:.*]] = alloca : !amdgcn.vgpr<0>
// CHECK-DAG:       %[[VAL_9:.*]] = alloca : !amdgcn.vgpr<1>
// CHECK-DAG:       %[[VAL_10:.*]] = alloca : !amdgcn.sgpr<0>
// CHECK-DAG:       %[[VAL_11:.*]] = alloca : !amdgcn.sgpr<2>
// CHECK-DAG:       %[[VAL_12:.*]] = alloca : !amdgcn.sgpr<5>
// CHECK:           test_inst outs %[[VAL_10]], %[[VAL_11]] : (!amdgcn.sgpr<0>, !amdgcn.sgpr<2>) -> ()
// CHECK:           test_inst outs %[[VAL_4]], %[[VAL_5]] : (!amdgcn.vgpr<2>, !amdgcn.vgpr<3>) -> ()
// CHECK:           test_inst outs %[[VAL_6]], %[[VAL_7]] : (!amdgcn.sgpr<1>, !amdgcn.sgpr<3>) -> ()
// CHECK:           test_inst outs %[[VAL_0]], %[[VAL_1]] : (!amdgcn.sgpr<8>, !amdgcn.sgpr<9>) -> ()
// CHECK:           test_inst outs %[[VAL_2]], %[[VAL_3]] : (!amdgcn.sgpr<10>, !amdgcn.sgpr<11>) -> ()
// CHECK:           test_inst outs %[[VAL_8]] ins %[[VAL_10]], %[[VAL_4]] : (!amdgcn.vgpr<0>, !amdgcn.sgpr<0>, !amdgcn.vgpr<2>) -> ()
// CHECK:           test_inst outs %[[VAL_9]] ins %[[VAL_11]], %[[VAL_5]] : (!amdgcn.vgpr<1>, !amdgcn.sgpr<2>, !amdgcn.vgpr<3>) -> ()
// CHECK:           %[[VAL_13:.*]] = make_register_range %[[VAL_0]], %[[VAL_1]], %[[VAL_2]], %[[VAL_3]] : !amdgcn.sgpr<8>, !amdgcn.sgpr<9>, !amdgcn.sgpr<10>, !amdgcn.sgpr<11>
...
// CHECK:           %[[VAL_4:.*]] = make_register_range %[[VAL_0]], %[[VAL_1]] : !amdgcn.vgpr<0>, !amdgcn.vgpr<1>
...
// CHECK-DAG:       %[[VAL_2:.*]] = alloca : !amdgcn.sgpr<2>
// CHECK-DAG:       %[[VAL_3:.*]] = alloca : !amdgcn.sgpr<3>
// CHECK-DAG:       %[[VAL_4:.*]] = alloca : !amdgcn.sgpr<4>
// CHECK:           test_inst outs %[[VAL_0]], %[[VAL_1]] : (!amdgcn.sgpr<0>, !amdgcn.sgpr<1>) -> ()
// CHECK:           test_inst ins %[[VAL_0]], %[[VAL_1]] : (!amdgcn.sgpr<0>, !amdgcn.sgpr<1>) -> ()
// CHECK:           test_inst outs %[[VAL_2]], %[[VAL_3]] : (!amdgcn.sgpr<2>, !amdgcn.sgpr<3>) -> ()
// CHECK:           test_inst ins %[[VAL_1]], %[[VAL_2]] : (!amdgcn.sgpr<1>, !amdgcn.sgpr<2>) -> ()
// CHECK:           test_inst outs %[[VAL_2]], %[[VAL_1]] : (!amdgcn.sgpr<2>, !amdgcn.sgpr<1>) -> ()
// CHECK:           test_inst ins %[[VAL_2]], %[[VAL_1]] : (!amdgcn.sgpr<2>, !amdgcn.sgpr<1>) -> ()
// CHECK:           test_inst outs %[[VAL_2]], %[[VAL_4]] : (!amdgcn.sgpr<2>, !amdgcn.sgpr<4>) -> ()
// CHECK:           test_inst ins %[[VAL_2]], %[[VAL_4]] : (!amdgcn.sgpr<2>, !amdgcn.sgpr<4>) -> ()
// CHECK:           test_inst ins %[[VAL_0]], %[[VAL_1]] : (!amdgcn.sgpr<0>, !amdgcn.sgpr<1>) -> ()
// CHECK:           end_kernel
// CHECK:         }
...
// CHECK:           sop2 s_and_b32 outs %[[VAL_2]] ins %[[VAL_2]], %[[CONSTANT_0]] : !amdgcn.sgpr<3>, !amdgcn.sgpr<3>, i32
...
// CHECK:           test_inst outs %[[VAL_0]] : (!amdgcn.vgpr<0>) -> ()
// CHECK:           test_inst outs %[[VAL_1]] : (!amdgcn.vgpr<1>) -> ()
// CHECK:           test_inst outs %[[VAL_1]] ins %[[VAL_1]] : (!amdgcn.vgpr<1>, !amdgcn.vgpr<1>) -> ()
...
// CHECK-DAG:       %[[ALLOCA_3:.*]] = amdgcn.alloca : !amdgcn.sgpr<1>
...
// CHECK-DAG:       %[[ALLOCA_0:.*]] = amdgcn.alloca : !amdgcn.vgpr<0>
// CHECK-DAG:       %[[ALLOCA_1:.*]] = amdgcn.alloca : !amdgcn.vgpr<1>
// CHECK-DAG:       %[[ALLOCA_2:.*]] = amdgcn.alloca : !amdgcn.vgpr<2>
// CHECK-DAG:       %[[ALLOCA_3:.*]] = amdgcn.alloca : !amdgcn.vgpr<3>
// CHECK-DAG:       %[[ALLOCA_4:.*]] = amdgcn.alloca : !amdgcn.sgpr<0>
// CHECK-DAG:       %[[ALLOCA_5:.*]] = amdgcn.alloca : !amdgcn.sgpr<1>
// CHECK-DAG:       %[[ALLOCA_6:.*]] = amdgcn.alloca : !amdgcn.sgpr<2>
// CHECK-DAG:       %[[ALLOCA_7:.*]] = amdgcn.alloca : !amdgcn.sgpr<3>
...
// CHECK-LABEL:   func.func @redundant_copies() {
...
// CHECK-DAG:       %[[VAL_2:.*]] = alloca : !amdgcn.vgpr<2>
// CHECK:           test_inst outs %[[VAL_0]] : (!amdgcn.vgpr<0>) -> ()
// CHECK:           test_inst outs %[[VAL_2]] : (!amdgcn.vgpr<2>) -> ()
// CHECK:           amdgcn.vop1.vop1 <v_mov_b32_e32> %[[VAL_1]], %[[VAL_2]] : (!amdgcn.vgpr<1>, !amdgcn.vgpr<2>) -> ()
// CHECK:           test_inst outs %[[VAL_1]] ins %[[VAL_2]] : (!amdgcn.vgpr<1>, !amdgcn.vgpr<2>) -> ()
// CHECK:           amdgcn.vop1.vop1 <v_mov_b32_e32> %[[VAL_1]], %[[VAL_0]] : (!amdgcn.vgpr<1>, !amdgcn.vgpr<0>) -> ()
...
// -----
// NOTE: This test is used to verify that allocated allocas are inserted in the correct order.
// The order is by range size, from largest to smallest, and by order of occurrence in the IR.
// That is the allocas in %9 have precedence over the allocas in %8.
// Also, %0 is allocated after %8 but before %1.
// CHECK-LABEL:   func.func @alloc_order() {
...
// CHECK:           %[[ALLOCA_6:.*]] = amdgcn.alloca : !amdgcn.vgpr<6>
// CHECK:           %[[ALLOCA_7:.*]] = amdgcn.alloca : !amdgcn.vgpr<7>
...
// CHECK:           amdgcn.test_inst ins %[[ALLOCA_6]], %[[ALLOCA_7]], %[[MAKE_REGISTER_RANGE_0]], %[[MAKE_REGISTER_RANGE_1]] : (!amdgcn.vgpr<6>, !amdgcn.vgpr<7>, !amdgcn.vgpr<[4 : 6]>, !amdgcn.vgpr<[0 : 4]>) -> ()
// CHECK:           return
// CHECK:         }
func.func @alloc_order() {
  %0 = amdgcn.alloca : !amdgcn.vgpr<?>
  %1 = amdgcn.alloca : !amdgcn.vgpr<?>
  %2 = amdgcn.alloca : !amdgcn.vgpr<?>
  %3 = amdgcn.alloca : !amdgcn.vgpr<?>
  ...
  %8 = amdgcn.make_register_range  %2, %3 : !amdgcn.vgpr<?>, !amdgcn.vgpr<?>
  %9 = amdgcn.make_register_range  %4, %5, %6, %7 : !amdgcn.vgpr<?>, !amdgcn.vgpr<?>, !amdgcn.vgpr<?>, !amdgcn.vgpr<?>
  amdgcn.test_inst ins %0, %1, %8, %9 : (!amdgcn.vgpr<?>, !amdgcn.vgpr<?>, !amdgcn.vgpr<[? : ? + 2]>, !amdgcn.vgpr<[? : ? + 4]>) -> ()
  amdgcn.reg_interference %0, %1, %8, %9 : !amdgcn.vgpr<?>, !amdgcn.vgpr<?>, !amdgcn.vgpr<[? : ? + 2]>, !amdgcn.vgpr<[? : ? + 4]>
  return
}
