...
func.func @test_scaled_mfma_16x16x128_basic(
    %a: !amdgcn.vgpr_range<[? + 8]>,
    %b: !amdgcn.vgpr_range<[? + 8]>,
    %c: !amdgcn.vgpr_range<[? + 4]>,
    %dst: !amdgcn.vgpr_range<[? + 4]>,
    %s0: !amdgcn.vgpr,
    %s1: !amdgcn.vgpr) {
...
func.func @test_scaled_mfma_16x16x128_agpr(
    %a: !amdgcn.vgpr_range<[? + 8]>,
    %b: !amdgcn.vgpr_range<[? + 8]>,
    %c: !amdgcn.agpr_range<[? + 4]>,
    %dst: !amdgcn.agpr_range<[? + 4]>,
    %s0: !amdgcn.vgpr,
    %s1: !amdgcn.vgpr) {
  %result = amdgcn.vop3p.vop3p_scaled_mai #amdgcn.inst<v_mfma_scale_f32_16x16x128_f8f6f4>
      %dst, %a, %b, %c, %s0, %s1
      : !amdgcn.vgpr_range<[? + 8]>, !amdgcn.vgpr_range<[? + 8]>,
        !amdgcn.agpr_range<[? + 4]>, !amdgcn.vgpr, !amdgcn.vgpr
      -> !amdgcn.agpr_range<[? + 4]>
  return
}
...
func.func @test_scaled_mfma_32x32x64_basic(
    %a: !amdgcn.vgpr_range<[? + 8]>,
    %b: !amdgcn.vgpr_range<[? + 8]>,
    %c: !amdgcn.vgpr_range<[? + 16]>,
    %dst: !amdgcn.vgpr_range<[? + 16]>,
    %s0: !amdgcn.vgpr,
    %s1: !amdgcn.vgpr) {
...
func.func @test_scaled_mfma_32x32x64_agpr_formats(
    %a: !amdgcn.vgpr_range<[? + 8]>,
    %b: !amdgcn.vgpr_range<[? + 8]>,
    %c: !amdgcn.agpr_range<[? + 16]>,
    %dst: !amdgcn.agpr_range<[? + 16]>,
    %s0: !amdgcn.vgpr,
    %s1: !amdgcn.vgpr) {
  %result = amdgcn.vop3p.vop3p_scaled_mai #amdgcn.inst<v_mfma_scale_f32_32x32x64_f8f6f4>
      %dst, %a, %b, %c, %s0, %s1 cbsz = 1 blgp = 3
      : !amdgcn.vgpr_range<[? + 8]>, !amdgcn.vgpr_range<[? + 8]>,
        !amdgcn.agpr_range<[? + 16]>, !amdgcn.vgpr, !amdgcn.vgpr
      -> !amdgcn.agpr_range<[? + 16]>
  return
}
...
func.func @test_scaled_mfma_sgpr_scales(
  ...
  %result = amdgcn.vop3p.vop3p_scaled_mai #amdgcn.inst<v_mfma_scale_f32_16x16x128_f8f6f4>
      %dst, %a, %b, %c, %s0, %s1
      : !amdgcn.vgpr_range<[? + 8]>, !amdgcn.vgpr_range<[? + 8]>,
        !amdgcn.vgpr_range<[? + 4]>, !amdgcn.sgpr, !amdgcn.sgpr
      -> !amdgcn.vgpr_range<[? + 4]>
  return
}
