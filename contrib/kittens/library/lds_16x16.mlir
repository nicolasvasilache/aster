...
amdgcn.library @kittens_lds_16x16 isa = [#amdgcn.isa<cdna3>] {
  ...
  //
  // Layout:
  //   A[0]: offset 0,   size 544 bytes
  //   B[0]: offset 544, size 544 bytes
  //   Total: 1,088 bytes
  func.func private @alloc_lds_1buffer() -> (index, index) {
    %A_base = amdgcn.alloc_lds 544 offset 0
    %B_base = amdgcn.alloc_lds 544 offset 544
  ...
  //
  // Layout:
  //   A[0]: offset 0,    size 544 bytes  (ping)
  //   B[0]: offset 544,  size 544 bytes  (ping)
  //   A[1]: offset 1088, size 544 bytes  (pong)
  //   B[1]: offset 1632, size 544 bytes  (pong)
  //   Total: 2,176 bytes
  func.func private @alloc_lds_2buffer() -> (index, index, index, index) {
    %A0_alloc = amdgcn.alloc_lds 544 offset 0
    %B0_alloc = amdgcn.alloc_lds 544 offset 544
    %A1_alloc = amdgcn.alloc_lds 544 offset 1088
    %B1_alloc = amdgcn.alloc_lds 544 offset 1632
  ...
  //   A[0]: offset 0,    size 544 bytes
  //   B[0]: offset 544,  size 544 bytes
  //   A[1]: offset 1088, size 544 bytes
  //   B[1]: offset 1632, size 544 bytes
  //   A[2]: offset 2176, size 544 bytes
  //   B[2]: offset 2720, size 544 bytes
  //   Total: 3,264 bytes
  func.func private @alloc_lds_3buffer() -> (index, index, index, index, index, index) {
    ...
    %A1_alloc = amdgcn.alloc_lds 544 offset 1088
    %B1_alloc = amdgcn.alloc_lds 544 offset 1632
    %A2_alloc = amdgcn.alloc_lds 544 offset 2176
    %B2_alloc = amdgcn.alloc_lds 544 offset 2720
